            ...
            <form method="post" action="/class-rooms/{{$classRoom->id}}" role="form" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="kode_kelas" class="form-control" id="kode_kelas" value="{{ $classRoom->kode_kelas }}" readonly>
                </div>

                <div class="form-group">
                  <label for="nama">Nama Kelas</label>
                  <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama" value="{{ $classRoom->nama }}">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control custom-select @error('teacher_id') is-invalid @enderror" id="teacher_id" name="teacher_id">
                    ...
                    @foreach ($teachers as $teacher)
                      ...
                      <option value="{{$teacher->id}}" {{ $classRoom->teacher_id == $teacher->id ? 'selected' : '' }}>{{$teacher->nama}}</option>                
