        ...
        <div class="card card-warning">
            ...
            <form method="post" action="/subjects" role="form" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <input type="text" name="kode_mapel" class="form-control @error('kode_mapel') is-invalid @enderror" id="kode_mapel" placeholder="Masukkan kode_mapel" value="{{ 'MP'.$kodeMataPelajaran }}" readonly>
