...
@section('header', 'Edit Data Pengumuman')
...
<div class="row">
   <div class="col-md-12">
      <div class="card card-warning">
         ...
         <form method="post" action="/informations/{{ $information->id }}" role="form" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="card-body">
