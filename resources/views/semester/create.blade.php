...
@section('header', 'Tambah Data Semester')
            ...
            <form method="post" action="/semesters">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tahun_ajaran" class="form-control @error('tahun_ajaran') is-invalid @enderror" id="tahun_ajaran" placeholder="Masukkan tahun ajaran" data-inputmask="'mask': ['9999/9999']" data-mask="" im-insert="true" value="{{ old('tahun_ajaran') }}">
