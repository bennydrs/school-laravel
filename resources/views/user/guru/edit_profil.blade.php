...
<div class="row">
  <div class="col-md-6">
    <div class="card card-success">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form method="post" action="/teacher/edit/{{$teacher->id}}" role="form" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror"
              id="tempat_lahir" value="{{ $teacher->tempat_lahir }}">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="tanggal_lahir"
                ...
                value="{{ $teacher->tanggal_lahir->format('Y-m-d') }}">
          ...
          <div class="form-group">
            ...
            <select class="form-control custom-select  @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin"
              ...
              <option value="Laki-laki" {{ $teacher->jenis_kelamin == 'Laki-laki' ? 'selected' : '' }}>Laki-laki
              </option>
              <option value="Perempuan" {{ $teacher->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>Perempuan
              </option>
            </select>
          ...
          <div class="form-group">
            ...
            <input type="telp" name="telp" data-inputmask="'mask': ['999-9999-9999']" data-mask="" im-insert="true"
              class="form-control @error('telp') is-invalid @enderror" id="telp" value="{{ $teacher->telp }}">
          ...
          <div class="form-group">
            ...
            <textarea name="alamat" class="form-control  @error('alamat') is-invalid @enderror" id="alamat"
              placeholder="Masukkan alamat">{{ $teacher->alamat }}</textarea>
